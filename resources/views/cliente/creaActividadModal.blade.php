<div class="modal fade" id="agregarContactoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        {!!Form::open(['route'=>'actividad.store','method'=>'POST', 'id' => 'myForm'])!!}
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
              @include('cliente.form.actividad')
...
<script>
$("#agregarContactoModal").draggable({
    handle: ".modal-header"
});
</script>